...
const FacilityCard = ({ image, venueName: title,  description,venueId,venueName,capacity,price }: { image: string; venueName: string; description: string, venueId: string ,capacity:string,price:string}) => {
